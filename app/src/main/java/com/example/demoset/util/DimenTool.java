 ...
 * 快速生成适配dimen文件 工具类
 * lzvgogo@gmail.com
 * 必须保持<dimen name="activity_horizontal_margin">26.666666666666668dp</dimen> 在同一行
 * 将defaultDp更改成默认的dp值，便可以生成相应的配置文件
 */
public class DimenTool {
//默认dimension 屏幕 dp值 ,defaultDp 400
...
//                                    tempString.indexOf("</dimen>") - 2));
                    int startP = tempString.indexOf(">")+1;
                    int endP = tempString.lastIndexOf("<") - 2;
                    String dp = tempString.substring(startP,endP);
                    Double num = Double.parseDouble(dp);
                    ...
                    sw540.append(start).append(num * defaultDp/540).append(end).append("\r\n");
                    sw1080.append(start).append(num * defaultDp/1080).append(end).append("\r\n");
...
// String sw800file = “values-sw800dp-land/dimens.xml”;
            ...
            File w540 = new File("./app/src/main/res/values-w540dp/dimens.xml");
            File w1080 = new File("./app/src/main/res/values-w1080dp/dimens.xml");
            ...
            writeFile(w540, sw540.toString());
            writeFile(w1080, sw1080.toString());
